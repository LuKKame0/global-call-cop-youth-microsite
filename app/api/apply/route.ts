...
import { sendApplyFormEmails } from "@/lib/email/marketing/apply";
import { applyFormSchema } from "@/lib/forms/marketing-schemas";
...
export async function POST(request: NextRequest) {
  ...
  const payload = parseJsonBody(body, applyFormSchema);
  ...
  try {
    ...
    await sendApplyFormEmails(payload);
